...
class MyTestCase(unittest.TestCase):
    def test_fetch_successful(self):
        ...
        expecteed_txt = "Recurring #wildfires, fuelled" \
                        " by rising #deforestation and more " \
                        "severe drought as the planet warms, co" \
                        "ntinue to dev… https://t.co/wUn9znVFv7"

        self.assertEqual(expecteed_txt, txt[0])
